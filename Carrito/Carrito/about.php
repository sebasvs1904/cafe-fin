        ...
        <div class="row mb-5">
          ...
          <div class="col-md-5">
            ...
            <div class="site-section-heading pt-3 mb-4">
              <h2 class="text-black">Nuestro Inicio</h2>
            </div>
            ...
            <div class="block-38 text-center">
              <div class="block-38-img">
                <div class="block-38-header">
                  ...
                  <h3 class="block-38-heading h4">María Pelaéz</h3>
                  <p class="block-38-subheading">CEO/Co-Foundador</p>
                </div>
            ...
            <div class="block-38 text-center">
              <div class="block-38-img">
                <div class="block-38-header">
                  ...
                  <h3 class="block-38-heading h4">Jennifer Sánchez</h3>
                  <p class="block-38-subheading">Co-Fundadora</p>
                </div>
                <div class="block-38-body">
                  <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Vitae aut minima nihil sit distinctio recusandae doloribus ut fugit officia voluptate soluta. </p>
                </div>
            ...
            <div class="block-38 text-center">
              <div class="block-38-img">
                <div class="block-38-header">
                  ...
                  <h3 class="block-38-heading h4">Patricio Sánchez</h3>
            ...
            <div class="block-38 text-center">
              <div class="block-38-img">
                <div class="block-38-header">
                  ...
                  <h3 class="block-38-heading h4">Israel Palestino</h3>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-6 col-lg-4 d-lg-flex mb-4 mb-lg-0 pl-4" data-aos="fade-up" data-aos-delay="">
            ...
            <div class="text">
              <h2 class="text-uppercase">Entrega gratis</h2>
          ...
          <div class="col-md-6 col-lg-4 d-lg-flex mb-4 mb-lg-0 pl-4" data-aos="fade-up" data-aos-delay="100">
            ...
            <div class="text">
              <h2 class="text-uppercase">Devoluciones sin cobro extra</h2>
              <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus at iaculis quam. Integer accumsan tincidunt fringilla.</p>
            </div>
          </div>
