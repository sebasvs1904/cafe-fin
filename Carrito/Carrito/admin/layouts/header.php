          ...
          <a href="#" class="dropdown-item">
            ...
            <div class="media">
              ...
              <div class="media-body">
                ...
                <p class="text-sm">Llamame por favor</p>
                <p class="text-sm text-muted"><i class="far fa-clock mr-1"></i>hace 4 min</p>
              </div>
            </div>
            <!-- Message End -->
          </a>
          ...
          <a href="#" class="dropdown-item">
            ...
            <div class="media">
              ...
              <div class="media-body">
                ...
                <p class="text-sm">No tenemos crema en almacen</p>
          ...
          <a href="#" class="dropdown-item">
            ...
            <div class="media">
              ...
              <div class="media-body">
                ...
                <p class="text-sm">Llegaron más clientes y no hay mesas disponibles</p>
                <p class="text-sm text-muted"><i class="far fa-clock mr-1"></i> Hace 5 seg</p>
              </div>
            </div>
            <!-- Message End -->
          </a>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      ...
      <span class="brand-text font-weight-light">COFFEE PLACE</span>
    </a>
