<?php 
  ...
  $resultado = $conexion ->query("
    select ventas.*, usuario.nombre, usuario.telefono, usuario.email from 
    ventas inner join usuario on ventas.id_usuario=usuario.id")or die($conexion->error);
          ...
          ?>
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <p>Correo electrónico Cliente: <?php echo $f['email']; ?> </p>
                        <p>Teléfono Cliente: <?php echo $f['telefono']; ?> </p>
                        <p>Status del pedido: <b style="color: red;"> <?php echo $f['status']; ?> </b></p>
                        <p class="h6">Datos de envío: <?php echo $f['nombre']; ?> </p>
                        <?php 
            ...
            <tbody>
                  ...
                  from productos_venta inner join productos on productos_venta.id_venta = productos.id 
           ...
           ?>
               <tr> 
                ...
                <?php number_format($f2['subtotal'],2,'.','');?>
        ...
        <form action="../php/insertarproducto.php" method="POST" enctype="multipart/form-data">
          ...
          <div class="modal-body">
              ...
              <div class="form-group">
                  ...
                  <input type="text" name="talla" placeholder="Tamaño" id="talla" class="form-control" required>
              </div>
              <div class="form-group">
      ...
      <div class="modal-content">
        <form action="../php/editarproducto.php" method="POST" enctype="multipart/form-data">
          ...
          <div class="modal-body">
              ...
              <div class="form-group">
                  <label for="tallaEdit">Tamaño</label>
                  <input type="text" name="talla" placeholder="Tamaño" id="tallaEdit" class="form-control" required>
              </div>
              <div class="form-group">
