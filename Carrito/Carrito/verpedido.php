<?php 
    ...
    ventas.*,
    usuario.nombre, usuario.telefono, usuario.email from ventas
...
<html lang="en">
  <head>
    <title>COFFE PLACE - Pedido</title>
    <meta charset="utf-8">
  ...
  <?php include("./layouts/header.php"); ?> 
    ...
    <div class="site-section">
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <h2 class="h3 mb-3 text-black">Detalles del cliente y envio</h2>
          </div>
          <div class="col-md-7">
            ...
            <form action="#" method="post">
              ...
              <div class="p-3 p-lg-5 border">
                ...
                <div class="form-group row">
                  <div class="col-md-6">
                    <label for="c_fname" class="text-black">Numero de venta: <?php echo $_GET['id_venta'];?> </label>
                  </div>
                </div>
                ...
                <div class="form-group row">
                  <div class="col-md-6">
                    <label for="c_fname" class="text-black">Código postal: <?php echo $datosEnvio[5];?> </label>
                  </div>
                </div> 
          ...
          ?>
            ...
            <img src="./images/<?php echo $f['imagen']; ?>" width="50px" alt="">
